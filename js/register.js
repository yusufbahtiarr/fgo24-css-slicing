...
passwordConfirmHidden.addEventListener('click', function() {
  if(passwordConfirmHidden.style.backgroundImage === 'url("../img/password-hidden.png")'){
    confirmInput.type = "text"
    passwordConfirmHidden.style.backgroundImage = 'url("../img/password-open.png")'
  }else{
    confirmInput.type = "password"
    passwordConfirmHidden.style.backgroundImage = 'url("../img/password-hidden.png")'
  }
})
